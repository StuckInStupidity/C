...
/* The function priceOption takes an argument of type Option *.   */
typedef struct{
...
/* The functions about insurance take an argument of type InsuredClient *.  */
typedef struct{
...
/* Initialize the integration variables.
   ...
   This functions sets the global variables pfaQF and pfa_dt to be used.
*/
